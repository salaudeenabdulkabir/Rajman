...
export default function GalleryPage() {
  ...
  const filtered = mockGalleryItems.filter(
    (item) =>
      item.is_published &&
          ...
          {filtered.length > 0 ? (
            <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 space-y-4">
              {filtered.map((item) => (
                <div
                  key={item.id}
                  className="break-inside-avoid rounded-2xl overflow-hidden bg-[#EFE7DB] group relative cursor-pointer"
                >
                  <div className="aspect-square bg-[#EFE7DB]" />
            ...
            <div className="flex flex-col items-center justify-center py-24 text-center">
              ...
              <p className="text-sm text-[#6B6B6B] max-w-sm mx-auto mb-8 leading-relaxed">
                We're building our portfolio gallery. Check back soon to see our finished work — or reach out to discuss your project now.
              </p>
              <a
